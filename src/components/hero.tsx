...
const Hero = () => {
  ...
  return (
    <div id="hero" className="hero bg-linear-to-r from-primary from-10% via-[#0B0367] via-50% to-secondary to-90% pt-32 pb-12 text-primary-content dark:from-secondary dark:to-primary">
